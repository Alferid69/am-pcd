...
class ApiService {
  ...
  static Future<http.Response> getStockRequests() async {
    ...
    return await http.get(Uri.parse('$baseUrl/stockRequests'), headers: headers);
  }
  ...
  static Future<http.Response> getTransactions() async {
    final headers = await getHeaders();
    return await http.get(Uri.parse('$baseUrl/transactions'), headers: headers);
  }
  ...
  static Future<http.Response> getRetailerData(String id) async {
    final headers = await getHeaders();
    return await http.get(Uri.parse('$baseUrl/retailerCooperatives/$id'), headers: headers);
  }
  
  static Future<http.Response> getCommodities() async {
    final headers = await getHeaders();
    return await http.get(Uri.parse('$baseUrl/commodities'), headers: headers);
  }

  static Future<http.Response> getCustomerByFayda(String fayda) async {
    final headers = await getHeaders();
    return await http.get(Uri.parse('$baseUrl/customers/fayda/$fayda'), headers: headers);
  }

  static Future<http.Response> getNotifications() async {
    final headers = await getHeaders();
    return await http.get(Uri.parse('$baseUrl/notifications'), headers: headers);
  }
